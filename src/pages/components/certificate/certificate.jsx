...
const Certificate = () => {
  return (
    <div className="Certificate">
      <div className="Certificate-title" data-aos="fade-up" aos-duration="2000">Some my certificate</div>
     ...
     <div className="Certificate--flex" data-aos="fade-up" aos-duration="2000">
        ...
        <img src={random} alt="" className="Random-img" data-aos="zoom-in-up" aos-duration="2000"/>
     </div>
    </div>
  );
};
